...
<body>
    ...
    <div class="container-fluid mt-4" id="form-variacao">
        ...
        echo "<table class='table'>
            ...
            include_once 'TrayListNotaFiscalIndividual.php';
             // INSTANCIA DO OBJETO DA CLASSE

            $GetNotasFiscais = new GetNotasFiscalDados($_SESSION['access_token_tray'],$_REQUEST['orderid'],$_REQUEST['invoice']);
            ...
            foreach ($NotaFiscal->OrderInvoices as $NotaFiscal) {
                ...
                echo "<td><a href='#'>{$NotaFiscal->OrderInvoice->order_id}</a></td>";
                ...
                echo "<td><a href='{$NotaFiscal->OrderInvoice->link}'>{$NotaFiscal->OrderInvoice->link}</a></td>";
                echo "</tr>";
            }
    echo "
      </tr>
