...
define("URL_BASE_GET_CATEGORIAS_TRAY_PRODUTO", "https://testeblipchat.commercesuite.com.br/web_api/");

class TrayListProduto{
    ...
    function resource($access_token,$page){
        ...
        $this->setPage($page);
        return $this->get('categories/?access_token='.$this->getAccess_token().'&limit='.$this->getPage());
    }

    function get($resource){
        // ENDPOINT PARA REQUISIÇÃO
        $endpoint = URL_BASE_GET_CATEGORIAS_TRAY_PRODUTO.$resource;
