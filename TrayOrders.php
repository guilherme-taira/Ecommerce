...
class GetPedidos{
    ...
    function __construct($access_token,$page,$dataInicial,$dataFinal)
    {
    ...
    function resource(){
        ...
        return $this->get('/orders/?access_token='.$this->getAccess_token().'&page='.$this->getPage());
    }
    ...
    function get($resource){
        ...
        $ch = curl_init();
        $uello = 'EXPRESSO';
        $dataRange = "{$this->getDataInicial()},{$this->getDataFinal()}";
        $shipment = curl_escape($ch, $uello);
        $dataPedido = curl_escape($ch,$dataRange);
        curl_setopt($ch, CURLOPT_URL, $endpoint . '&shipment=' . $shipment. '&date='.$dataPedido);
