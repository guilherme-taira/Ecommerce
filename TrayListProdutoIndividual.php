...
define("URL_BASE_GET_PRODUTO_PUT_TRAY_PRODUTO", "https://testeblipchat.commercesuite.com.br/web_api/");

class TrayListProdutoIndividual{
    ...
    function resource($access_token,$id){
    ...
    function get($resource){
        ...
        $endpoint = URL_BASE_GET_PRODUTO_PUT_TRAY_PRODUTO.$resource;
