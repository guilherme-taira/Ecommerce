...
class CadastrarNewOrder implements Cadastrar {
    ...
    $NumeroCasa,$referencia,$cep,$vizinho,$cidade,$uf,$ChaveNf,$NumeroNf,$dataNf,$serieNf,$TotalNf,$Peso,$cpf,PDO $pdo,$complement,$quantityVolume,$dataVolumes)
    {
            $this->status = $status;
    ...
    public function CadastrarOrdem(){
        ...
        try {
              ...
              nomeCliente,email,telefone,endereco,NumeroCasa,referencia,cep,vizinho,cidade,uf,chaveNota,NumeroNf,dataNf,serieNf,TotalNf,Peso,documento,complement,volumes,dataVolume)";
              ...
              $sql_values = " VALUES(:status,:Orderid,:date,:customer_id,:partial_total,:taxes,:discount,:point_sale,
                                    ...
                                    :Peso,:documento,:complement,:volumes,:dataVolume)";
              ...
              $statement->bindValue(':volumes',$this->getQuantityVolume(),PDO::PARAM_STR);
              $statement->bindValue(':dataVolume',$this->getDataVolumes(),PDO::PARAM_STR);
              $statement->execute();
              $this->pdo->commit();
