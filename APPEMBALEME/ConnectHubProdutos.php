...
<body>
    <div class="container-fluid mt-2" id="atualiza">
        <div class="row">
            ...
            $getProdutos = new GetProdutosBling();
            $jsonDecodificado = $getProdutos->resource('a0e92e1b13cad53953fa6b425bc6cb36bcf51d327ec8ca3c9a0c20d271edb3585cc96277', $pagina);
            //    echo "<pre>"; 
            ...
            foreach ($jsonDecodificado->Products as $produtos) {
                ...
                foreach ($produtos as $produto) {
                    ...
                    if (count($count) > 0) {
                        echo "
                            <li class='list-group-item  mt-2 alert alert-danger'><strong>Produto : {$produto->name} - Já Cadastrado!</strong></li>
                            ";
                    } else {
                        echo "
                            <li class='list-group-item mt-2 alert alert-success'><strong>Produto : {$produto->name} - Cadastrado com Sucesso</strong></li>
                            ";
